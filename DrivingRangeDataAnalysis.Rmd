...
```{r club-speed-boxplot, echo=FALSE, warning=FALSE}
plot_boxplot(
  data = data,
  x_var = Club.Name,
  y_var = Club.Speed,
...
```
```{r attack-angle-boxplot, echo=FALSE, warning=FALSE}
plot_boxplot(
  data = data,
  x_var = Club.Name,
  y_var = Attack.Angle,
...
```{r club-face-histogram, echo=FALSE, warning=FALSE}
...
```{r club-path-histogram, echo=FALSE, warning=FALSE}
